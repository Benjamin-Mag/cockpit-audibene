...
export function App() {
  ...
  const hidden: TabId[] = page === 'lead' ? ['mails', 'chat'] : page === 'opportunity' ? ['anamnese', 'commentaire', 'partenaires'] : [];
  ...
  return (
    <>
      ...
      <main class="content">
        ...
        {activeTab === 'partenaires' && <Partenaires data={data} update={update} toast={showToast} />}
        {activeTab === 'mails' && (
